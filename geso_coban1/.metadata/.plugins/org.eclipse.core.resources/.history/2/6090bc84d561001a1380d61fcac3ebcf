...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
						...
						<!-- the in PDF  --> 
								<%if(obj.getMaDonHang().length()>0){ %>
									<TD width="50px" align="left">
											<!-- the in PDF  --> 
									<A  href="../../DonBanHangPdf_ThuSvl?userId=<%=userId %>&pdf=<%= obj.getMaDonHang()%>" >
									 <IMG src="../images/printericon.png" title="In Đơn Hàng" alt="In Chúng từ" border="1px" style="border-style: outset">
									</A>
									</TD>
									<%} %>	
 ...
 -->									<!-- the in excel  --> 
								<%if(obj.getMaDonHang().length()>0){ %>
										<TD width="50px" align="left">
								<A	href="../../DonBanHangExcel_ThuSvl?userId=<%=userId %>&excel=<%= obj.getMaDonHang()%>">
								<IMG src="../images/excel.gif" title="In Đơn Hàng"
								alt="In Đơn Hàng" border="1px" style="border-style: outset; width: 30px">
								</A>
									</TD>
									<%} %>	
