...
<body>
<form name="sanphamlist" method="post" action="../../SanphamNhom2ListSvl">
    ...
    <div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> san pham </span>&nbsp;&nbsp;
								...
								<tr>
								    	...
								    	<TD class="plainlabel"> 
								    	 <input   type="text" name="ma" style="width:200px" onchange="submitform()" value="<%=obj.getMa()%>">
								    		...
								    		<TD class="plainlabel"> 
								    		 <input   type="text" name="ten" style="width:200px" onchange="submitform()" value="<%=obj.getTen()%>">
						     ...
						     <TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
		                        ...
		                        <%} %>
				                	<th> <%=count%> </th>
				                		...
				                		<th> 
				                		  <A href = "../../SanphamNhom2ListSvl?userId=<%=userId%>&update=<%= dataList.getString("PK_SEQ")%>">
