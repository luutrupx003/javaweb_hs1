		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<TABLE  border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									...
									<TD width="30px" align="left">
									<span id="btnUndo">	
										<A  href="../../SanPhamList_Trang?userId=<%=userId%>"> <IMG src="../images/Back_undo.png" title="Undo" alt="Undo" border="1px" style="border-style: outset"></A>
									</span>
									</TD>
								</TR>
								</TABLE>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								...
								<TD class="plainlabel">
									<input type="text" name="tenSanPham" value = "<%= obj.getTenSanPham()%>"
									>	
								</TD>
							</TR>
							<TR>
								...
								<TD class="plainlabel">
									<select name = "donViTinh" style="width: 200px">
									<option value=""></option>
									<% 
										if (rsDonViTinh != null) {
									...
									%>
													<option value="<%= rsDonViTinh.getString("PK_SEQ") %>" selected = "selected" >
							...
							<TR>
								...
								<TD class="plainlabel">
									<input type="number" name = "soLuong" value = "<%= obj.getSoLuong() %>" placeholder = "EX:8">	
								</TD>
							</TR>	
							<TR>
								<TD class="plainlabel">
								...
								<TD class="plainlabel">
									<input type="number" name = "giaBan" value = "<%= obj.getGiaBan() %>" placeholder = "EX: 1000000">	
								</TD>
							</TR> 
						</TABLE>
						<hr>
