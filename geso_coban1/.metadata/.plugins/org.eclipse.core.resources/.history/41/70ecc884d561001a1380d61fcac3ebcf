					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"> 
								<input type="text" name="ma" value="<%=nccBean.getMa()%>"> </TD>
									 ...
									 <%if(rsdvt!=null) {
										while(rsdvt.next()) {
											if(rsdvt.getString("pk_seq").equals(nccBean.getDvt())){
												%>
												<option value="<%=rsdvt.getString("pk_seq")%>" selected="selected"><%=rsdvt.getString("ma") %> </option>
												<%
											}else{
												 %>
												 <option value="<%=rsdvt.getString("pk_seq")%>" ><%=rsdvt.getString("ma") %> </option>
												 <%
											}
										}
