...
<input type="hidden" name="idmahoso" value="<%=obj.getMahoso() %>" >
    ...
    <div align="left" id="button" style=" border:1;width: 100%; height: 32px; padding: 1px; float: none"  class="tbdarkrow">
			...
			<div class="plainlabel">
			 ...
			 <TABLE width="100%" cellpadding="6px" cellspacing="0px"  >	
				 <tr>
					 <td class="plainlabel" >
		        		<label  class="plainlabel">Ngày Tạo Hồ Sơ:</label>  <input class="plainlabel" readonly type="text" maxlength="10" name="ngaytaohoso" value="<%=hs.getNgaytaohoso()%>" /> 
		        	</td>
		        	<td class="plainlabel" >
		        		<label  class="plainlabel">Ngày Tư vấn:</label>  <input class="days"  type="text" maxlength="10" name="ngaytuvan" value="<%=obj.getNgaytuvan() %>" />
		        	</td>
	        	</tr>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <fieldset style="margin-top:5px" >
                ...
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                     ...
                     <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text"  readonly name="hotenhs" value="<%=hs.getHoten() %>" />
                        </TD>
                        <TD class="plainlabel" width="15%" >Ngày sinh</TD>
                        <TD class="plainlabel" >
                            <input type="text"  maxlength="10" readonly name="ngaysinhhs" value="<%=hs.getNgaysinh() %>" />
                        </TD>
                    </TR>
                     <TR >
                   ...
                   <TR >
                    ...
                    <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text" readonly name="diachihs"  maxlength="10" value="<%=hs.getDiachi() %>"  />
                        </TD> <TD class="plainlabel" width="15%" >Điện thoại</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly  maxlength="10" name="dienthoaihs" value="<%=hs.getDienthoai() %>" />
                        </TD>
                    </TR>
                      <tr>
                   	<td colspan="4" style="background-color:#C5E8CD ">
                   		<a href="" id="noidungGhiChu" rel="ndGhiChu">&nbsp; <img alt="Thêm Quốc Gia" src="../images/vitriluu.png">Chi Tiết Học Sinh</a>
                    ...
                    <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="emailhs" value="<%=hs.getEmail() %>" />
                        </TD>
                         <TD class="plainlabel" width="15%" >FaceBook</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="facebookhs" value="<%=hs.getfacebook()%>" />
                        </TD>
                    </TR>
                    <tr>
                     ...
                     <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="hotencha" value="<%=hs.getHoten_cha()%>" />
                        </TD>
                        <TD class="plainlabel" width="15%" >Họ Tên mẹ</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="hotenme" value="<%=hs.getHoten_me() %>" />
                        </TD>
                    </TR>
             		 <TR >
                        <TD class="plainlabel" width="15%" >Sinh Ngày</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="ngaysinhcha" value="<%=hs.getNgaysinh_cha() %>" />
                        </TD>
                         <TD class="plainlabel" width="15%" >Sinh Ngày</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="ngaysinhme" value="<%=hs.getNgaysinh_me() %>" />
                        </TD>
                    </TR>
                    <TR >
                        <TD class="plainlabel" width="15%" >Địa chỉ (Nếu khác ở trên)</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly name="diachicha"   maxlength="10" value="<%=hs.getDiachi_cha() %>" />
                        </TD>
                         <TD class="plainlabel" width="15%" >Địa chỉ (Nếu khác ở trên)</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly name="diachime"   maxlength="10" value="<%=hs.getDiachi_me() %>" />
                        </TD>
                    </TR>
                    <TR >
                        <TD class="plainlabel" width="15%" >Số Điện thoại</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="dienthoaicha" value="<%=hs.getDienthoai_cha()%>" />
                        </TD>
                        <TD class="plainlabel" width="15%" >Số Điện thoại</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="dienthoaime" value="<%=hs.getDienthoai_me()%>" />
                        </TD>
                    </TR>
                    ...
                    <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="nghenghiepcha" value="<%=hs.getNghenghiep_cha() %>" />
                        </TD>
                        <TD class="plainlabel" width="15%" >Nghề Nghiệp</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="nghenghiepme" value="<%=hs.getNghenghiep_me()%>" />
                        </TD>
                    </TR>
                  <TR >
                        <TD class="plainlabel" width="25%" >Thu nhập hàng tháng của gia đình</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="thunhap" value="<%=hs.getThunhap_GD()%>" />
                        </TD>
                        <TD class="plainlabel" width="25%" >Email Khác(Nếu có)</TD>
                        <TD class="plainlabel" >
                            <input type="text" readonly maxlength="10" name="emailkhac" value="<%=hs.getEmail_khac() %>" />
                        </TD>
                    </TR>
                    </TABLE>                  
		</div>
		...
		<div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
                ...
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px;color: #369 " >								                          
                     ...
                     &nbsp; <img alt="Thêm Quốc Gia" src="../images/vitriluu.png">Thêm Quốc Gia</a>
                             <DIV id="themquocgia" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
                                 background-color: white; width: 500px; min-height:150px; overflow:auto; padding: 4px;">
                         <table width="100%" align="center">
                            <tr>
                                <th colspan="2" width="500px" style="font-size: 14px;font-weight: bold;">THÊM QUỐC GIA</th>
                                
                            </tr>
                               
                                <tr>
                                <td width="20%"> Mã quốc gia </td>
                                <td width="80%"> <input style="width:100%"  name="maquocgia" type="text" value="<%=obj.getQuocgia_fk()%>" >  </td>
                            </tr>
                            ...
                            <tr>
                              <td>
                                ...
                                <td width="300px">
                                 <A href="javascript:savequocgia()"> <IMG src="../images/1455966997_save.png" title="Save" alt="Save" border="1px" style="border-style: outset"> Lưu Quốc Gia</A>
                 	 ...
                 	 <TR >
                        ...
                        <TD class="plainlabel" >
                            <textarea style="width:400px" rows="4" cols="10" name="diengiai"  ><%=obj.getDiengiai() %></textarea>
                        </TD>
                    </TR>
                    <TR >
                        <TD class="plainlabel" width="15%" >Nhận xét</TD>
                        <TD class="plainlabel" >
                             <textarea style="width:400px" rows="4" cols="5" name="nhanxet" > <%= obj.getNhanxet() %></textarea>
                        </TD>
                    </TR>
                    <TR >
                        ...
                        {%>
                            ...
                            <%}else if(obj.getTiemnang().equals("1")){ %>
