					...
					<fieldset>
						...
						<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
							...
							<TR class='tblightrow'>
								...
								<TD align="center">
								<A href = "../../DonmuahangNewSvl?userId=<%=userId%>&display=<%= dataList.getString("ma") %>">
								<IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>&nbsp;
								
										<% if (tt.equals("0"))
											{%>
										<A href = "../../DonmuahangListSvl?userId=<%=userId%>&delete=<%= dataList.getString("ma") %>">
										<img src="../images/DeleteRed_32.png" width="20" height="20" border=0 
                                			name=delete alt="Xóa" title="Xóa" ></A>&nbsp;
                                			<A href="../../DonmuahangNewSvl?userId=<%=userId%>&update=<%=dataList.getString("ma")%>">
										<IMG src="../images/edit32.png" width="20" height="20" border=0 name=update 
										alt="Cap nhat" title="Cập nhật"> </A>&nbsp;
										
										<A href = "../../DonmuahangListSvl?userId=<%=userId%>&chot=<%= dataList.getString("ma") %>">
										<img src="../images/Chot.png" alt="Chốt" width="20" height="20" title="Chốt" border="0"
                                		name=chot alt="Chốt" title="Chôt" ></A>&nbsp;
		                                <%} %>
