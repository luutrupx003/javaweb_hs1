...
<body>
	<form name="erpDmhForm" method="post" action="../../DonHangListSvl_Kiet02">
					...
					<TR class="tbdarkrow">
						...
						<td width="30px" align="left"><A
							href="../../Excel_DonHangSvl_kiet02?userId=<%=userId%>"> <IMG
								src="../images/Excel2013.png" alt="Xuất file Excel" title="Xuất file Excel"
								border=0> </A>
						</td>
						...
						<TABLE width="100%" cellpadding="6" cellspacing="0">
							<tr>
								...
								<TD class="plainlabel" width="90%"><input type="text"
									...
									value="<%=obj.getMaDonHang()%>" placeholder="Ex: Đỗ Minh Kiệt =))">
								</TD>
							</tr>
							<tr>
 ...
 %> <A
									href="../../DonHangListSvl_Kiet02?userId=<%=userId%>&chot=<%=dataList.getString("MADONHANG")%>">
										...
										alt="Chot don hang" title="Chốt" border=0> </A>&nbsp; <A
