...
public class SanPham_TrangSvl extends HttpServlet{
	private static final long serialVersionUID = 1L;
    
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SanPham_TrangSvl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    ISanPham_Trang obj = new SanPham_Trang();	    
	    if(action.equals("update") || action.equals("display"))
	    {
	    ...
	    if(action.equals("save")) { 
		    ...
		    obj.setNguoiTao(userId);
	    		if(!obj.saveSanPham()){
	    			...
	    			//luu  thanh cong
	    			ISanPhamList_Trang obj1 = new SanPhamList_Trang();
	    			obj1.init("");	    		
