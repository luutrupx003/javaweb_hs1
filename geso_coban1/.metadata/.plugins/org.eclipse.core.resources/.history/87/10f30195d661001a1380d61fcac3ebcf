    ...
    <div align="left" id="button" style=" border:1;width: 100%; height: 32px; padding: 1px; float: none"  class="tbdarkrow">
			...
			<div class="plainlabel">
			 ...
			 <TABLE width="100%" cellpadding="6px" cellspacing="0px"  >	
				 <tr>
					 <td class="plainlabel" >
		        		<label  >Ngày tạo hồ sơ:</label>  <input class="days" type="text" maxlength="10" name="ngaytuvan" value="<%=obj.getNgaytaohoso()%>" disabled/>
		        	</td>
	        	</tr>
        	</TABLE>
        	</div>
		...
		<div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
                ...
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    ...
                    <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text" readonly  maxlength="10" name="facebookkhac" value="<%=obj.getfacebook_khac() %>" />
                        </TD>
                    </TR>
