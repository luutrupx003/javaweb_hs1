...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../DonBanHangUpdate_TrangSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<div align="left" id="button" style=" border:1;width: 100%; height: 60px; padding: 1px; float: none"  class="tbdarkrow">
			
			<TABLE  border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									<TD width="50px" height="60px" align="left">
									<span id="btnUndo">	
									...
									<TD width="50px" height="60px" align="left">
										<span id="btnInpdf">
											<A href="../../DonBanHangInPDF_TrangSvl?userId=<%=userId %>&pdf=<%= obj.getId()%>">
												<img title="inPDF" alt="In Đơn Hàng" src="../images/printericon.png" border="1px" style="border-style: outset">
											</A>
										</span>
									</TD>
									...
									<TD width="50px" height="60px" align="left">
										<span id="btnInexcel">
											<A href="../../DonBanHangInExcel_TrangSvl?userId=<%=userId %>&excel=<%= obj.getId()%>">
												<IMG src="../images/excel.gif" title="In đơn hàng" alt="In đơn hàng" border="1px" style="border-style: outset">
											</a>
										</span>
									</TD>
								</TR>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								...
								<TD class="plainlabel">
									<select disabled name = "maKhachHang" style="width: 200px" >
									<option value="" ></option>
									<% 
										if (rsKhachHang != null) {
							...
							<TR>
								...
								<TD class="plainlabel">
									<input type="text" readonly="readonly" name="ngayChungTu"  class="days" value = "<%= obj.getNgayChungTu()%>"
									>	
								</TD>
							</TR>
							<TR>
								...
								<TD class="plainlabel">
									<input type="text" readonly="readonly"  name = "tongTien" value = "<%= obj.getTongTien() %>">	
								</TD>
							</TR>		 
						</TABLE>
						...
						%>
							<tr>
								 <TD align="center" width="5%">
												<input  type="text" value="<%= soLuongSanPham + 1 %>" style="text-align: center;" readonly="readonly">
												<input type="hidden" value="<%=sp.getSanPhamPK_SEQ() %>" name="idsp" style="width:5%" readonly="readonly" > 
												 
											</TD>
											 
											<TD  align="center" width="10%" >
												<input type="text" readonly="readonly" name="masp" style="width: 100%" value="<%=sp.getMaSanPham() %>"  onkeyup="ajax_showOptions(this,'donmuahang',event)" AUTOCOMPLETE="off"  > 
											</TD>
											<TD align="left" width="10%">
													<input type="text" readonly="readonly" value="<%=sp.getTenSanPham() %>" name="tensp" style="width: 100%" > 
												 
											</TD>
											<TD align="center" width="10%">
												<input type="text" readonly="readonly" value="<%=sp.getDonViTinh() %>" name="donvitinh" style="width: 100%" > 
											</TD>
											<TD align="center" width="10%">
												<input type="text" readonly="readonly" value="<%=sp.getSoLuong() %>" name="soluong" style="width: 100%; text-align: right;"> 
											</TD>
											<TD align="center" width="10%">
												<input type="text" readonly="readonly" value="<%=sp.getSoLuongTon() %>" name="soluongton" style="width: 100%; text-align: right;"> 
											</TD>
											<TD align="center" width="10%">
												<input type="text" readonly="readonly" value="<%=sp.getDonGia() %>" name="dongia" style="width: 100%; text-align: right;"> 
											</TD>
											 			
											<TD align="center" width="10%">
												<input type="text" readonly="readonly" value="<%=sp.getThanhTien() %>"  name="thanhtien" style="width: 100%; text-align: right;"  > 
								</TD>
							</tr>
						<% 
					}%>
