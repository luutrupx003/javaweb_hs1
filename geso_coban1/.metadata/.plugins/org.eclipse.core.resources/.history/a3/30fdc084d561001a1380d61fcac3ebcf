			...
			<div align="left" id="button"
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						width="30px" align="left"><A
							href="javascript:print_excel()"> <IMG src="../images/Excel.jpg"
								title="Xuất chứng từ" alt="Xuất chứng từ" border="1px"
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" class="days" name="ngaychungtu"
                          			...
                          			<DIV id="ndGhiChu" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                        ...
				                        <tr>
		                            	 ...
		                            	 <tr>
				                            ...
				                            <td width="80%"> <input style="width:100%"  name="mancc" type="text" value="<%=obj.getKhachhang()%>" >  </td>
				                        </tr>
				                        
				                        <tr>
				                            <td width="300px"> Tên khách hàng  </td>
				                            <td width="300px"> <input style="width:100%"  name="tenncc" type="text" value="<%=obj.getTenkhachhang()%>" >  </td>
				                        </tr>
				                        
				                        <tr>
				                            <td width="300px"> Điện thoại </td>
				                            <td width="300px"> <input style="width:100%" type="text" name="dienthoaincc" value<%= obj.getDienthoai() %>>  </td>
				                        </tr>
				                        
				                        <tr>
				                            <td width="300px"> Địa chỉ</td>
				                            <td width="300px"> <input style="width:100%" type="text" name="diachincc" value<%= obj.getDiachi() %> >  </td>
				                        </tr>
						...
						<TABLE class="tabledetail" width="100%" border="0" cellpadding="2" cellspacing="2" style="font-size: 14px;">
							...
							for(  i=0;i<listsp.size();i++) {
								...
								<Td align="center" width="10%"><input type="text" name="thanhtien" value="<%=formatter.format(sp.getThanhtien())%>"></Td>			  
							</TR>
