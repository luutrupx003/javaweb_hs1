...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../DonBanHangNew_TrinhSvl">
		<input type="hidden" name="userId" value='<%= userId %>'> 
		<input type="hidden" name="action" value="<%=action%>" />
		<input type="hidden" name="maDonHang" value='<%= obj.getMaDonHang() %>'>
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<TABLE  border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									<TD width="50px" height = "60" align="center">
									<span id="btnUndo">	
										<A  href="../../DonBanHang_TrinhSvl?userId=<%=userId%>"> <IMG src="../images/Back_undo.png" title="Undo" alt="Undo" border="1px" style="border-style: outset"></A>
									</span>
									</TD>
									<TD  width="50px" height = "60" align="center">
										<span id="btnInpdf">	
											<A  href="../../DonBanHangInPdf_TrinhSvl?userId=<%=userId %>&pdf=<%= obj.getMaDonHang()%>" > <IMG src="../images/printericon.png" title="In đơn hàng" alt="In đơn hàng" border="1px" style="border-style: outset"></A>
										</span>
									</TD>

									<TD  width="50px" height = "60" align="center">
										<span id="btnInExcel">	
											<A  href="../../DonBanHangInExcel_TrinhSvl?userId=<%=userId %>&excel=<%= obj.getMaDonHang()%>" > <IMG src="../images/excel.gif" title="In đơn hàng" alt="In đơn hàng" border="1px" style="border-style: outset"></A>
										</span>
									</TD>
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<textarea name="dataerror" id="Msg" rows="1" readonly="readonly" style="height: 50px; width: 100%"><%= obj.getMessage() %></textarea>
				</fieldset>
			</div>
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								...
								<TD class="plainlabel">
									...
									%>
													<option value="<%= rsKhachHang.getString("MAKHACHHANG") %>" selected = "selected" >
							...
							<TR>
								...
								<TD class="plainlabel">
									<input type="text" name="ngayChungTu"   readonly="readonly"
