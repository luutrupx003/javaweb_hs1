			...
			<TABLE  border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									...
									<TD width="30px" align="left">
									 <IMG src="../images/1455966997_save.png" title="Save" alt="Save" border="1px" style="border-style: outset"></A>
									</TD>
									<TD width="30px" align="left">
									<span id="btnUndo">	
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							 ...
							 <tr>
								     	<TD class="plainlabel">Tên NCC</TD>
								  		  <td class="plainlabel"  >  
				                    	<select disabled name="tenncc"  style="width:200px">
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" name="ngay" value="<%=obj.getngay() %>" readonly> </TD>
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" name="tongtien" value="<%=obj.gettongtien() %>" > </TD>
