...
<%@page import="geso.erp.beans.Tienhanhhopdongdaky_hieu.imp.TienhanhhopdongdakyUpdate"%>
<%@page import="geso.erp.beans.Tienhanhhopdongdaky_hieu.ITienhanhhopdongdakyUpdate"%>
		...
		<div id="main" style="width: 100%; padding-left: 2px">
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<TD width="30px" align="left"><span id="btnUndo"> <A
								href="../../TienhanhhopdongdakyListSvl_hieu?userId=<%=userId%>"> <IMG
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<tr>
								...
								<TD class="plainlabel"><select readonly="readonly"  name="mahopdong"
					...
					<fieldset>
					<legend class="legendtitle"> Thông tin cá nhân khách hàng </legend>
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
					<TR >
                        <TD class="plainlabel" width="15%" >Họ Tên</TD>
                        <TD class="plainlabel" >
                            <input type="text"  readonly name="hotenhs" value="<%=obj.getHotencanhan() %>" />
                        </TD>
                    ...
                    <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text"  readonly name="hocvan" value="<%=obj.getTrinhdohocvan() %>" />
                        </TD>
                        <TD class="plainlabel" width="15%" >Khả năng tiếng anh</TD>
                        <TD class="plainlabel" >
                            <input type="text"  maxlength="10" readonly name="tienganh" value="<%=obj.getkhanangtienganh() %>" />
                        </TD>
                    </TR>
                    ...
                    <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text"  readonly name="nguyenvongdihoc" value="<%=obj.getNguyenvong() %>" />
                        </TD>
                        <TD class="plainlabel" width="15%" >Khả năng học vấn</TD>
                        <TD class="plainlabel" >
                            <input type="text"  maxlength="10" readonly name="khananghocvan" value="<%=obj.getKhananghocvan() %>" />
                        </TD>
                    </TR>
					...
					<TR >
                        <TD class="plainlabel" width="15%" >Số hợp đồng</TD>
                        <TD class="plainlabel" >
                            <input type="text"  readonly name="sohopdong" value="<%=obj.getSohopdong() %>" />
                        </TD>
                        <TD class="plainlabel" width="15%" >Ngày ký hợp đồng</TD>
                        <TD class="plainlabel" >
                            <input type="text"  maxlength="10" readonly name="ngaykyhopdong" value="<%=obj.getNgaykyhopdong() %>" />
                        </TD>
                    </TR>
                    <TR >
                        <TD class="plainlabel" width="15%" >Quốc gia đã chọn </TD>
                        <TD class="plainlabel" >
                            <input type="text"  readonly name="quocgia" value="<%=obj.getQuocgia() %>" />
                        </TD>
                        <TD class="plainlabel" width="15%" >Giá trị hợp đồng</TD>
                        <TD class="plainlabel" >
                            <input type="text"  maxlength="10" readonly name="giatrihopdong" value="<%=obj.getGiatrihopdong() %>" />
                        </TD>
                    </TR>
					...
					<TR >
    					...
    					<div style="padding-right: 6px;">
                            <textarea readonly="readonly"  rows="5" name="chuanbi"  style="font-family:Times New Roman;color:#003399;white-space:pre-wrap "  ">
                             <%=obj.getChuanbi()%>
                            </textarea>
                             </div>
                              </div>
                    ...
                    <TR >
                        ...
                        <TD class="plainlabel" >
                            <input readonly="readonly" class="days" type="text"  name="ngayphongvan" value="<%=obj.getNgayphongvan() %>" />
                        </TD>
                    </TR>
                     <TR >
                        <TD class="plainlabel" width="15%" >Giờ phỏng vấn</TD>
                        <TD class="plainlabel" >
                            <input readonly="readonly" type="text"  name="giophongvan" value="<%=obj.getGiophongvan() %>" />
                        </TD>
                    </TR>
                    <TR >
                        <TD class="plainlabel" width="15%" >Ngày nhập học dự kiến </TD>
                        <TD class="plainlabel" >
                            <input readonly="readonly" class="days" type="text"  name="ngaynhaphocdukien" value="<%=obj.getNgaynhaphocdukien() %>" />
                        </TD>
                    </TR>
