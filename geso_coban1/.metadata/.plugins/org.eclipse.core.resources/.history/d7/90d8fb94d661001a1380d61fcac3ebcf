					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								...
								<TD class="plainlabel"><input class="days" type="text" name="ngayghinhan" id="ngayghinhan" value="<%=obj.getNgayghinhan() %>" maxlength="10" > </TD>

							</TR>
							<TR>
								<TD class="plainlabel">Ly Do</TD>
								<TD class="plainlabel"><input type="text" name="lydo" value="<%=obj.getLydo()%>"> </TD>

							</TR>
							 <tr>
							     	<TD class="plainlabel">Kho Chuyen</TD>
							  		  <td class="plainlabel"  >  
			                    	<select name="khochuyen"  style="width:200px" onchange="loadsanpham();">
			                    		<option value=""></option>
			                    	 	<%
							...
							<tr>
							     	<TD class="plainlabel">Kho nhan</TD>
							  		  <td class="plainlabel"  >  
			                    	<select name="khonhan"  style="width:200px">
						...
						<TABLE class="tabledetail" width="100%" border="0" cellpadding="2" cellspacing="2" style="font-size: 14px;">
							...
							int i;
								...
								<Td align="center" width="15%">
									...
									<input type="text" name="masp" value="<%=sp.getMasanpham()%>" onkeyup="ajax_showOptions(this,'donmuahang',event)" AUTOCOMPLETE="off"> 
								</Td>
								...
								<Td align="center" width="5%"><input type="text" name="soluongton" value="<%=sp.getSoluong()%>" readonly></Td>
								 <Td align="center" width="10%"><input type="text" name="soluongchuyen" value="<%=sp.getBooked()%>"></Td>
								</TR>
							<%} %>	
							<%
