	...
	<form name="dmhForm" method="post" action="../../SanphamNewSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation">Thong tin sanpham </div>
			...
			<TABLE  border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									...
									<TD width="30px" align="left">
									<span id="btnUndo">	
										<A  href="../../SanphamListSvl?userId=<%=userId%>"> <IMG src="../images/Back_undo.png" title="Undo" alt="Undo" border="1px" style="border-style: outset"></A>
									</span>
									</TD>
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<textarea name="dataerror" id="Msg" rows="1" readonly="readonly" style="width: 100%"><%=nccBean.getmsg()%></textarea>
				</fieldset>
			</div>
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" name="ma" value="<%=nccBean.getMa()%>"> </TD>

							</TR>
							<TR>
								<TD class="plainlabel">Tên</TD>
								<TD class="plainlabel"><input type="text" name="ten" value="<%=nccBean.getTen()%>"> </TD>
									 ...
									 <%if(rsdvt!=null) {
										while(rsdvt.next()) {
											if(rsdvt.getString("pk_seq").equals(nccBean.getDvt())){
												%>
												<option value="<%=rsdvt.getString("pk_seq")%>" selected="selected"><%=rsdvt.getString("ten") %> </option>
												<%
											}else{
												 %>
												 <option value="<%=rsdvt.getString("pk_seq")%>" ><%=rsdvt.getString("ten") %> </option>
												 <%
											}
										}
							...
							<TR>
								...
								<input type="checkbox" name="tinhtrang" checked="checked" value="1"> 
								<%}else {%> 
