...
<%@page import="geso.erp.beans.Dinhhuongthitruong_hieu.IDinhhuongthitruongUpdate_hieu"%>
<%@page import="geso.erp.beans.Dinhhuongthitruong_hieu.IDinhhuong_hoatdong"%>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post"
		...
		<div id="main" style="width: 100%; padding-left: 2px">
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						<TD width="30px" align="left"><span id="btnUndo"> <A
								href="../../DinhhuongthitruongListSvl_hieu?userId=<%=userId%>"> <IMG
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					<legend class="legendtitle"> Thêm danh sách định hướng hoạt động </legend>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<TD class="plainlabel"><input type="text" name="tinhtrang"
									style="width: 400px"
									value="<%=obj.getTinhtrangthitruong()%>" readonly="readonly"></TD>
							</tr>
							<tr>
								...
								<td class="plainlabel">
									...
									%> <select readonly="readonly" name="thang" style="width: 200px">
										<option value=""></option>
										<%
							...
							<tr>
								...
								<td class="plainlabel">
									...
									%> <select name="nam" readonly="readonly"
									style="width: 200px">
										<option value=""></option>
										<%
						...
						<div align="left" style="width: 100%; float: none; clear: none;">
							...
							for(  i=0;i<listhd.size();i++) {
								...
								<TR>
									...
									<Td align="center" width="10%"><input type="hidden" name="idhd" value="<%=hd.getId()%>"> 
									<input type="text" name="tenhd" value="<%=hd.getTenhoatdong()%>" readonly="readonly">
									</Td>
									<Td align="center" width="35%"><input type="text" name="mota" value="<%=hd.getMota()%>" readonly="readonly">
									</Td>
									<Td align="center" width="10%"><input type="text" name="kinhphi" value="<%=hd.getKinhphi()%>" readonly="readonly">
									</Td>
									<Td align="center" width="10%"><input class="days" type="text" name="tungay" value="<%=hd.getTungay()%>" readonly="readonly">
									</Td>
									<Td align="center" width="10%"><input class="days" type="text" name="denngay" value="<%=hd.getDenngay()%>" readonly="readonly">
									</Td>
									<Td align="center" width="10%"><input type="text" name="slkh" value="<%=hd.getSoluongkh()%>" readonly="readonly">
									</Td>
									<Td align="center" width="10%"><input type="text" name="slhd" value="<%=hd.getSoluonghd()%>" readonly="readonly">
									</Td>
								</TR>
							 ...
							 for(i=listhd.size();i<listhd.size()+10 ;i++) {
								...
								<TR>
									...
									<Td align="center" width="10%"><input type="text"
										name="tenhd" value="" readonly="readonly">
									</Td>
									<Td align="center" width="35%"><input type="text"
										name="mota" value="" readonly="readonly">
									</Td>

									<Td align="center" width="5%"><input type="text"
										name="kinhphi" value="" readonly="readonly"></Td>
									<Td align="center" width="5%"><input class="days" type="text"
										name="tungay" value="" readonly="readonly"></Td>
									<Td align="center" width="5%"><input class="days" type="text"
										name="denngay" value="" readonly="readonly"></Td>
										<Td align="center" width="5%"><input type="text"
