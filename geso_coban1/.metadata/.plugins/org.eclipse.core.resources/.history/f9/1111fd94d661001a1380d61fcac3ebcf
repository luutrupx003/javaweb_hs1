						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<TD class="plainlabel"><input type="text" name="tinhtrang"
									style="width: 400px"
									value="<%=obj.getTinhtrangthitruong()%>"></TD>
							</tr>
							<tr>
						...
						<div align="left" style="width: 100%; float: none; clear: none;">
							...
							for(  i=0;i<listhd.size();i++) {
								...
								<TR>
									...
									<Td align="center" width="15%"><input type="hidden" name="idhd" value="<%=hd.getId()%>"> 
									<input type="text" name="tenhd" value="<%=hd.getTenhoatdong()%>">
									</Td>
									<Td align="center" width="30%"><input type="text" name="mota" value="<%=hd.getMota()%>">
									</Td>
									<Td align="center" width="10%"><input type="text" name="kinhphi" value="<%=hd.getKinhphi()%>">
									</Td>
									<Td align="center" width="10%"><input class="days" type="text" name="tungay" value="<%=hd.getTungay()%>">
									</Td>
									<Td align="center" width="10%"><input class="days" type="text" name="denngay" value="<%=hd.getDenngay()%>">
									</Td>
									<Td align="center" width="10%"><input type="text" name="slkh" value="<%=hd.getSoluongkh()%>">
									</Td>
									<Td align="center" width="10%"><input type="text" name="slhd" value="<%=hd.getSoluonghd()%>">
									</Td>
								</TR>
							 ...
							 for(i=listhd.size();i<listhd.size()+10 ;i++) {
								...
								<TR>
									...
									<Td align="center" width="5%"><input class="days" type="text"
										name="tungay" value=""></Td>
									<Td align="center" width="5%"><input class="days" type="text"
										name="denngay" value=""></Td>
										<Td align="center" width="5%"><input type="text"
										name="slkh" value=""></Td>
									<Td align="center" width="5%"><input type="text"
										name="slhd" value=""></Td>
