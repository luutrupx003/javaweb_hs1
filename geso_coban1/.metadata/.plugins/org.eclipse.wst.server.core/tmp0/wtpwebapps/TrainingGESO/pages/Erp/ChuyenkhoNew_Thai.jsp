			 ...
			 <div id="cotent" style="width:100%; float:none">
					        ...
					        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
					        	<fieldset>
					                		 ...
					                		 <LEGEND class="legendtitle">Tiêu chí tìm kiếm &nbsp;</LEGEND>
												<TABLE  width="100%" cellpadding="6" cellspacing="0">
													<tr>
													    ...
													    <TD class="plainlabel"><input type="text" name="ngaychuyen" style="width:200px"  value="<%=obj.getNgaychuyen()%>"></TD>
													</tr>
													<tr>
													  	<TD class="plainlabel">Lý do chuyển </TD>
													    <TD class="plainlabel"><input type="text" name="lydochuyen" style="width:200px"  value="<%=obj.getLydochuyen()%>"></TD>
													</tr>
													<tr>
														<td class="plainlabel">Kho chuyển</td>
														<td class="plainlabel">
															<select name="khochuyen"  style="width:200px">
																<option> </option>
																<%if(getListKC != null)
								    ...
								    <TD class="plainlabel" >
								    	<select name="trangthai" style="width:200px">
