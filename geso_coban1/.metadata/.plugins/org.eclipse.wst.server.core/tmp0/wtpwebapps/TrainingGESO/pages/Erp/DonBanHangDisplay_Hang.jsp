			...
			<TABLE  border="0" cellpadding="0" cellspacing="0">
				<TR class = "tbdarkrow">
					<TD  width="40px"  align="left">
						<span id="btnInpdf">	
							<A  href="../../DonBanHangInPdf_HangSvl?userId=<%=userId %>&pdf=<%= obj.getId()%>" > <IMG src="../images/printericon.png" title="In đơn hàng" alt="In đơn hàng" border="1px" style="border-style: outset"></A>
						</span>
					</TD>
					...
					<TD  width="40px" align="left">
						<span id="btnInExcel">	
							<A  href="../../DonBanHangInExcel_HangSvl?userId=<%=userId %>&excel=<%= obj.getId()%>" > <IMG src="../images/excel.gif" title="In đơn hàng" alt="In đơn hàng" border="1px" style="border-style: outset"></A>
						</span>
					</TD>
					<TD width="40px" align="left">
						<span id="btnUndo">	
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel">
									<input type="text" name="ngayChungTu"  class="days" value = "<%= obj.getNgayChungTu()%>" readonly="readonly">	
								</TD>
							</TR>
							<TR>
								<TD class="plainlabel">
						...
						<TABLE class="tabledetail" width="100%" border="0" cellpadding="2" cellspacing="2" style="font-size: 14px;">
							...
							for(i = 0; i<listsp.size();i++){
								...
								%>
									...
									<td><input type = "text" name = "maSanPham" value = "<%=sp.getMaSanPham()%>" onkeyup="ajax_showOptions(this,'donmuahang',event)" AUTOCOMPLETE="off" readonly="readonly"></td>
									<td><input type = "text" name = "tenSanPham" value = "<%=sp.getTenSanPham()%>" readonly="readonly"></td>
									<td><input type = "text" name = "donViTinh" value = "<%=sp.getDonViTinh()%>" readonly="readonly"></td>
									<td><input type = "text" name = "soLuong" value = "<%=sp.getSoLuong()%>" readonly="readonly"></td>
