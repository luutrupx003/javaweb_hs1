					...
					<%
                   	...
                   	%>
		                    ...
		                    %>
				                    ...
				                    <TD align="center">
				                    	<A href = "../../DonBanHangUpdate_HangSvl?userId=<%=userId%>&display=<%= dataList.getString("MADONHANG") %>">
				                    ...
				                    %>
											<% if (!maTrangThai.equals("1")) {%>
												<A href = "../../DonBanHang_HangSvl?userId=<%=userId%>&chot=<%= dataList.getString("MADONHANG")%>">
				                               		<IMG src="../images/Chot.png" width="20" height="20" alt="Chot don hang" title="Chốt" border=0>
												</A>&nbsp;
												<A href = "../../DonBanHangUpdate_HangSvl?userId=<%=userId%>&update=<%= dataList.getString("MADONHANG") %>">
				                               		<IMG src="../images/edit32.png" width="20" height="20" alt="Cap nhat" title="Cập nhật" border=0>
												</A>&nbsp;
												<A href = "../../DonBanHang_HangSvl?userId=<%=userId%>&delete=<%= dataList.getString("MADONHANG")%>">
