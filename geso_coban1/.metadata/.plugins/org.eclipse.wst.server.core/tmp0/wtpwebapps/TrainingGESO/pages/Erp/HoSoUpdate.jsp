    ...
    <div align="left" id="button" style=" border:1;width: 100%; height: 32px; padding: 1px; float: none"  class="tbdarkrow">
			...
			<TABLE  border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									...
									<TD width="30px" align="left">
									<span id="btnUndo">	
										<A  href="../../HoSoListSvl?userId=<%=userId%>"> <IMG src="../images/Back_undo.png" title="Undo" alt="Undo" border="1px" style="border-style: outset"></A>
									</span>
			...
			<div class="plainlabel">
			 ...
			 <TABLE width="100%" cellpadding="6px" cellspacing="0px"  >	
				 <tr>
					 <td class="plainlabel" >
		        		<label  >Ngày tạo hồ sơ:</label>  <input class="days" type="text" maxlength="10" name="ngaytuvan" value="<%=obj.getNgaytaohoso()%>" />
		        	</td>
	        	</tr>
        	</TABLE>
        	</div>
  	<div id="cotent" style="width:100%; float:none">
        ...
        <fieldset style="margin-top:5px" >
        	...
        	<legend>
                ...
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                     ...
                     <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text" class="days"  maxlength="10" name="ngaysinhhs" value="<%=obj.getNgaysinh() %>" />
                        </TD>
                    </TR>
                     <TR >
                     ...
                     <TR >
                        ...
                        <TD class="plainlabel" >
		                     <select class="select2" name="litsquocgia" id="spId" style="width: 200px;" multiple='multiple' onchange="submitform()">
						          <option value="" ></option>
						          <%
                    		...
                    		<a href="" id="noidungGhiChu" rel="ndGhiChu">
                          			...
                          			<DIV id="ndGhiChu" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width: 300px; min-height:150px; overflow:auto; padding: 2px;">
				                        ...
				                        <tr>
		                            	 ...
		                            	 <tr>
				                            ...
				                            <td width="60%"> <input style="width:100%"  name="maquocgia" type="text" value="<%=obj.getMaquocgia()%>" >  </td>
				                        </tr>
				                        
				                        <tr>
				                            <td width="40"> Tên quoc gia</td>
				                            <td width="60"> <input style="width:100%"  name="tenquocgia" type="text" value="<%=obj.getTenquocgia()%>" >  </td>
				                        </tr>
				                        ...
				                        <tr>
				                            ...
				                            <td width="300px">
				                            	<A href="javascript:savequocgia()"> <IMG src="../images/1455966997_save.png" title="Save" alt="Save" border="1px" style="border-style: outset"></A>
				                            	
				                            	<a href="javascript:dropdowncontent.hidediv('ndGhiChu')"  > <IMG src="../images/exit_1.png" title="Close" alt="Close" border="1px" style="border-style: outset"> </a>
                    ...
                    <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text" name="diachihs" maxlength="10" value="<%=obj.getDiachi() %>"  />
			...
			<div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
       		 <fieldset style="margin-top:5px" >
       		 <legend>
			  	<span style="color:red" class="legendtitle">Thông tin phụ huynh</span>&nbsp;&nbsp;  
			  	</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                     ...
                     <TR >
             		 ...
             		 <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text" class="days" maxlength="10" name="ngaysinhcha" value="<%=obj.getNgaysinh_cha() %>" />
                        </TD>
                         <TD class="plainlabel" width="15%" >Sinh Ngày</TD>
                        <TD class="plainlabel" >
                            <input type="text" class="days"  maxlength="10" name="ngaysinhme" value="<%=obj.getNgaysinh_me() %>" />
                        </TD>
                    </TR>
                    <TR >
