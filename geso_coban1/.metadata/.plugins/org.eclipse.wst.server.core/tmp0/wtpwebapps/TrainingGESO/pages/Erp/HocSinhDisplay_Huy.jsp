    ...
    <div align="left" id="button" style=" border:1;width: 100%; height: 32px; padding: 1px; float: none"  class="tbdarkrow">
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <fieldset style="margin-top:5px" >
        	<div >
        	<label  class="plainlabel">Ngày tư vấn:</label>  <input class="plainlabel" readonly type="text" value="" maxlength="10" name="ngaytuvan" value="<%=obj.getNgaytuvan()%>" />
        	</div>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    <TR >
                     ...
                     <TR >
                        ...
                        <TD class="plainlabel" >
                      <select name="litsquocgia"  onchange="submitform()" style="width:200px" disabled>
                    		<option value=""></option>
                    	 	<%
                    	 		if(rsqg!=null)
                    	 		{
                    ...
                    <TR >
                        ...
                        <TD class="plainlabel" >
                            <input type="text" readonly name="diachihs"  value="" maxlength="10" value="<%=obj.getDiachi() %>"  />
