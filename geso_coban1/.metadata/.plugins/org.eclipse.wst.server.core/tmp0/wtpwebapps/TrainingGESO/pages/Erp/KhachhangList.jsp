	...
	<div align="left" id="header" style="width:100%; float:none">
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> Khách hàng </span>&nbsp;&nbsp;
            	...
            	<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
	                ...
	                <td align="center" colspan="4">  <input   type="text" name="ma" style="width:100%" onchange="submitform()" value="<%=obj.getMa()%>">
									   </td>
	                ...
	                <td align="center">  <%
                    	...
                    	%>                     
                    	<select name="trangthai"  onchange="submitform()" style="width:100%">
                    	 <option value="">  </option> 
                    	<%
	                ...
	                <tr class='tblightrow'>
	                 <td align="center"  style="font-size:16;font-weight: bold; "> * </td>
	                 
	                <td align="center"  >  <input   type="text" name="manew" style="width:100%"  value="<%=obj.getMaNew()%>"> 
	                <input   type="hidden" name="idnew" style="width:100%"  value="<%=obj.getId()%>">
	                </td>
					<td align="center"  >  <input   type="text" name="tennew" style="width:100%"   value="<%=obj.getTenNew()%>"></td>
					<td align="center"  >  <input   type="text" name="dienthoainew" style="width:100%"  value="<%=obj.getDienthoaiNew()%>"></td>
					<td align="center"  >  <input   type="text" name="diachinew" style="width:100%"   value="<%=obj.getDiachiNew()%>"></td>  
									   
	                <td align="center">  
	                  
	                  <% if(obj.getTrangthaiNew().equals("1")){ %>
	                  	<input checked="checked" type="checkbox" name="checktrangthai" value='1'>
	                  <%}else{ %>
	                  		<input  type="checkbox" name="checktrangthai" value='1'>
	                  <%} %>
	                
	                 </td>
	                <td align="center"> <A  href="javascript:save_new()"> <IMG src="../images/1455966997_save.png" title="Thêm mới" alt="Luu lai" border="1px" style="border-style: outset;width: 25px;height: 25px"></A> </td>
                   			...
                   			{  		
		                        ...
		                        <%} %>
				                    ...
				                    <TD align="center">
		                               ...
		                               <A href = "../../KhachhangSvl?userId=<%=userId%>&update=<%= dataList.getString("sochungtu")%>">
