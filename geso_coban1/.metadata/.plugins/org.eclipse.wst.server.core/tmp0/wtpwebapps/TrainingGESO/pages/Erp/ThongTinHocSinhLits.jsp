        	...
        	<fieldset>
				...
				<TABLE  width="100%" cellpadding="6" cellspacing="0">
					<tr>
					    ...
					    <TD class="plainlabel"> 
					     <input   type="text" name="tenhs" style="width:200px" onchange="submitform()" value="">
                   		...
                   		if(dataList != null)
                   		{
		                       ...
		                       <TR class='tblightrow' >
				                    ...
				                    <TD align="center" >
				                     ...
				                     <TD align="center">
				                     <A href = "../../HocSinhUpdateSvl?userId=<%=userId%>&display=<%= dataList.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>&nbsp;
				               
		                               <A href = "../../HocSinhUpdateSvl?userId=<%=userId%>&update=<%= dataList.getString("PK_SEQ")%>">
		                               		<IMG src="../images/edit32.png" width="20" height="20" alt="Cap nhat" title="Cập nhật" border=0></A>&nbsp;
		                             
										    <A href = "../../HocSinhListSvl?userId=<%=userId%>&delete=<%= dataList.getString("PK_SEQ") %>"><img src="../images/DeleteRed_32.png" width="20" height="20" border=0 
                                					 alt="Xóa hoc sinh" title="Xóa hoc sinh" onclick="if(!confirm('Bạn có muon xoa hoc sinh này?')) return false;"></A>&nbsp;
