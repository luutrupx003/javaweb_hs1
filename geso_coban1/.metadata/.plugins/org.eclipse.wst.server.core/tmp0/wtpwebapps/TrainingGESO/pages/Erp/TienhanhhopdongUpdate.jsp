							...
							<TABLE width="100%" cellpadding="4" cellspacing="0">
								<TR>
									...
									<TD class="plainlabel"><input type="text" readonly
										name="hotenhs" value="<%=obj.getHotencanhan()%>" />
									</TD>
                             ...
                             <textarea style="width:400px" rows="4" cols="5" name="nhanxet" > <%= obj.getChuanbi() %></textarea>
								...
								<TR>
									...
									<TD class="plainlabel"><input class="days" type="text"
										...
										value="<%=obj.getNgaynhaphocdukien()%>" />
									</TD>
								</TR>
								<tr>
