    		...
    		<td colspan="2">
    			<div class="input-field-login icon username-container">
		            <input name="username" id="username" autofocus="autofocus" placeholder="Vui lòng nhập tên đăng nhập." 
		                    class="std_textbox" tabindex="1" required="" type="text" AUTOCOMPLETE="off" value="<%= request.getParameter("username") != null ? request.getParameter("username") : "" %>" >
		        </div>
    		</td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		<td colspan="2">
    			<div class="input-field-login icon password-container">
		            <input name="password" id="password" placeholder="Vui lòng nhập mật khẩu." class="std_textbox" tabindex="2" required="" type="password" AUTOCOMPLETE="off" valu >
		        </div>
    		</td>
    	</tr>
    	<tr>
    		...
    		<td colspan="2">
    			<div class="input-field-login icon username-container">
		            <input name="captchas" id="captchas" autofocus="autofocus" placeholder="Vui lòng nhập mã xác nhận." 
		                    class="std_textbox" tabindex="3" required="" type="text" AUTOCOMPLETE="off">
		        </div>
    		</td>
    	</tr>
    	<tr>
