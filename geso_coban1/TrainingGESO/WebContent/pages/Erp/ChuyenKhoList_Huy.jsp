                		 ...
                		 <LEGEND class="legendtitle">Tiêu chí tìm kiếm &nbsp;</LEGEND>
							<TABLE  width="100%" cellpadding="6" cellspacing="0">
								<tr>
								    ...
								    <TD class="plainlabel"> 
								     <input  type="text" name="makho" style="width:200px" onchange="submitform()" value="">
                   		...
                   		if(dataListchuyenkho != null)
                   		{
                   			...
                   			{  		
          						%>
				                   ...
				                   <TD align="center">
				                     <A href = "../../ChuyenKhoUpdateSvl?userId=<%=userId%>&display=<%= dataListchuyenkho.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>&nbsp;
				                <% if(tt.equals("0")){ %>
		                               <A href = "../../ChuyenKhoUpdateSvl?userId=<%=userId%>&update=<%= dataListchuyenkho.getString("PK_SEQ")%>">
		                               		<IMG src="../images/edit32.png" width="20" height="20" alt="Cap nhat" title="Cập nhật" border=0></A>&nbsp;
		                             		
										     <A href = "../../ChuyenKhoUpdateSvl?userId=<%=userId%>&chot=<%= dataListchuyenkho.getString("PK_SEQ") %>"><img src="../images/Chot.png" width="20" height="20" border=0 
                                					 alt="chot Quản lý mua hàng" title="chot Quản lý chuyen kho" onclick="if(!confirm('Bạn có muốn chot đơn mua hàng này?')) return false;"></A>&nbsp;
										    <A href = "../../ChuyenKhoUpdateSvl?userId=<%=userId%>&delete=<%= dataListchuyenkho.getString("PK_SEQ") %>"><img src="../images/DeleteRed_32.png" width="20" height="20" border=0 
