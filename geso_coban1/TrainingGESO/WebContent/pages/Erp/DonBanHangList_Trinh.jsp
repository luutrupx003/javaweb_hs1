...
<body>
<form name="erpDmhForm" method="post" action="../../DonBanHang_TrinhSvl">
								    ...
								    <%
				                        while(rsKhachHang.next()){/*cau lenh de giu gia tri lai tren compobox*/
				                        	if(rsKhachHang.getString("MAKHACHHANG").equals(obj.getMaKhachHang())){
												%>
													<option selected="selected" value="<%=rsKhachHang.getString("MAKHACHHANG")%>"> 
					...
					<%
                   	...
                   	%>
		                    ...
		                    %>
				                    ...
				                    <TD align="left">
				                    	<A href = "../../DonBanHangNew_TrinhSvl?userId=<%=userId%>&display=<%= dataList.getString("MADONHANG") %>">
				                    ...
				                    %>
											<% if (!maTrangThai.equals("1")) {%>
												<A href = "../../DonBanHang_TrinhSvl?userId=<%=userId%>&chot=<%= dataList.getString("MADONHANG")%>">
				                               		<IMG src="../images/Chot.png" width="20" height="20" alt="Chot don hang" title="Chốt" border=0>
												</A>&nbsp;
												<A href = "../../DonBanHangNew_TrinhSvl?userId=<%=userId%>&update=<%= dataList.getString("MADONHANG") %>">
				                               		<IMG src="../images/edit32.png" width="20" height="20" alt="Cap nhat" title="Cập nhật" border=0>
												</A>&nbsp;
												
												<A href = "../../DonBanHang_TrinhSvl?userId=<%=userId%>&delete=<%= dataList.getString("MADONHANG")%>">
