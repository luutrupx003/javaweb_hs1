...
<body>
<form name="erpDmhForm" method="post" action="../../DonBanHang_TrangSvl">
<input type="hidden" name="userId" value="<%= userId %>" >
<input type="hidden" name="action" value="" >
<input type="hidden" name="crrApprSplitting" value="<%= obj.getCrrApprSplitting() %>" >
<input type="hidden" name="nxtApprSplitting" value="<%= obj.getNxtApprSplitting() %>" >

<input type="hidden" name="msg" value='<%= obj.getMsq() %>'>
<script language="javascript" type="text/javascript">
    thongbao();
</script> 
...
<div id="main" style="width:100%; padding-left:2px">
     ...
     <div align="left" id="button" style=" border:1;width: 100%; height: 32px; padding: 1px; float: none"  class="tbdarkrow">
			...
			<TABLE  border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									...
									<span id="btnthem">	
										<A href="javascript:taomoi()"> <IMG src="../images/add32.png" title="Tạo mới" alt="Tạo mới" border="1px" style="border-style: outset;width: 25px;height: 25px"></A> 
									</span>
    ...
    <div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle">Mã đơn hàng</span>&nbsp;&nbsp; </legend>
                		 <LEGEND class="legendtitle">Tìm kiếm &nbsp;</LEGEND>
							<TABLE  width="100%" cellpadding="6" cellspacing="0">
								<tr>
								  	<TD class="plainlabel">Mã đơn hàng</TD>
								    <TD class="plainlabel">
								    	<input type = "text" name = "maDonHang" onchange = "submitform()" value = "<%=obj.getMaDonHang()%>"placeholder = "Ex: 100000">
								    </TD>
								</tr>
	...
	<!-- GHI CHÚ: HIỂN THỊ SỰ KIỆN--> 
		<!-- HIỂN THỊ SỰ KIỆN: VIEW ĐƠN HÀNG -->
				                    <TD align="left">
				                    	<A href = "../../DonBanHangUpdate_TrangSvl?userId=<%=userId%>&display=<%= dataList.getString("MADONHANG") %>">
				                    		<IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0>
				                    	</A>&nbsp;
									
	
								<% if(maTrangThai.equals("0")){%>
		<!-- HIỂN THỊ SỰ KIỆN: CHỐT ĐƠN HÀNG -->
										<A href="../../DonBanHang_TrangSvl?userId=<%=userId %>&chot=<%=dataList.getString("MADONHANG")%>">
											<img alt="Chot" src="../images/Chot.png" title="Chốt" width="20" height="20"  border=0>
										</A>&nbsp;
										
		<!-- HIỂN THỊ SỰ KIỆN: UPDATE ĐƠN HÀNG -->
										<A href="../../DonBanHangUpdate_TrangSvl?userId=<%=userId %>&update=<%=dataList.getString("MADONHANG")%>">
											<img alt="Cap nhat" src="../images/edit32.png" title="Cập nhật" width="20" height="20" border=0> 
										</A>&nbsp;
										
		<!-- HIỂN THỊ SỰ KIỆN: DELETE ĐƠN HÀNG -->
										<A href="../../DonBanHang_TrangSvl?userId=<%=userId%>&delete=<%= dataList.getString("MADONHANG")%>">
											<img alt="Xoa" src="../images/DeleteRed_32.png" title="Xoá" height="20" width="20" border=0> 
										</A>&nbsp;
