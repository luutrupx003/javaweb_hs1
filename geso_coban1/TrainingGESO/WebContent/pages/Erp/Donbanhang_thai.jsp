	...
	<form name="dmhForm" method="post" action="../../DonhangNewSvl_thai">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Đơn bán hàng</div>
			...
			<TABLE  border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									...
									<TD width="30px" align="left">
									<span id="btnUndo">	
										<A  href="../../DonbanhangListSvl_thai?userId=<%=userId%>"> <IMG src="../images/Back_undo.png" title="Undo" alt="Undo" border="1px" style="border-style: outset"></A>
									</span>
									</TD>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<tr>
								    ...
								    <td class="plainlabel">
								    <select name="khachhang" style="width:200px">
				                    	<option value="">  </option> 
								    <%
								    if(listKH!=null)
				                        while(listKH.next()){
				                        	if(obj.getKhachhang().trim().equals(listKH.getString("Khachhang"))){
												%>
													<option selected="selected" value="<%=listKH.getString("Khachhang")%>"> <%=listKH.getString("TEN") %> </option>
												<%
												}else{
												%>
													<option value="<%=listKH.getString("Khachhang")%>"> <%=listKH.getString("TEN")%> </option>
												<%
				                        	   }
						      	...
						      	<tr>
								    ...
								    <TD class="plainlabel"><input type="text" name="ngay" style="width:200px" value="<%=obj.getNgaychungtu()%>"></TD>
								</tr>
							<tr>
								  	<TD class="plainlabel">Số tiền</TD>
								    <TD class="plainlabel"><input type="text" name="tongtien"  id="tongtien" style="width:200px" value="<%=obj.getTongtien()%>"></TD>
								</tr>					
								...
								%>
								 ...
								 <TD align="center" width="2%">
											...
											<TD align="center" width="7%">
												<input type="number" value="<%=sp.getSoluong() %>" name="soluong" style="width: 100%; text-align: right;"  onkeyup="FormatNumber(this)"  > 
											</TD>
											<TD align="center" width="8%">
							...
							while (i< 20+listsp.size()) {%>
								<tr>
								 <TD align="center" width="2%">
											...
											<TD align="center" width="7%">
												<input type="number" value="" name="soluong" style="width: 100%; text-align: right;"  onkeyup="FormatNumber(this)"  > 
											</TD>
											<TD align="center" width="8%">
