...
<body>
<form name="erpDmhForm" method="post" action="../../ErpBCDoanhSoTheoSPSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	 Quản lý cung ứng > Báo cáo > Hàng xuất kho
        </div>
    ...
    <div align="left" style="width:100%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror" style="height: 50px; width: 100%;color: red" readonly="readonly" readonly="readonly"><%= obj.getMsg() %></textarea>
		         <% obj.setMsg(""); %>
    	</fieldset>
  	</div>
  	<div id="cotent" style="width:100%; float:none">
    	...
    	<fieldset>
					<legend class="legendtitle">Báo cáo doanh số theo sản phẩm</legend>
					<div style="width: 100%; float: none" align="left"
						...
						<TABLE width="70%" cellpadding="6" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel">
									<input type="text" name="tungay" id="tungay" class="days" value='<%=obj.gettungay() %>' /></TD>
		                    ...
		                    <% String checked1 = loaiBaoCao.equals("1") ? "checked=\"checked\"" : "";  
		                   	...
		                   	<TR>
								...
								<TD class="plainlabel" >
									<input type="radio" name="loaiBaoCao" value="0" <%=checked0 %>>Sell in
								</TD>
								<TD class="plainlabel">
									<input type="radio" name="loaiBaoCao" value="1" <%=checked1 %> >Sell out
								</TD>
							</TR> 
