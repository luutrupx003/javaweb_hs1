					...
					<%
                   	...
                   	%>
		                    ...
		                    %>
				                    ...
				                    <TD align="center">
				                    	<A href = "../../SanPhamUpdate_HangSvl?userId=<%=userId%>&display=<%= dataList.getString("MASANPHAM") %>">
				                    		<IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0>
				                    	</A>&nbsp;
				                   	
											<% if (maTrangThai.equals("1")) {%>
												
												<A href = "../../SanPhamUpdate_HangSvl?userId=<%=userId%>&update=<%= dataList.getString("MASANPHAM") %>">
				                               		<IMG src="../images/edit32.png" width="20" height="20" alt="Cap nhat" title="Cập nhật" border=0>
												</A>								
												<A href = "../../SanPham_HangSvl?userId=<%=userId%>&delete=<%= dataList.getString("MASANPHAM")%>">
