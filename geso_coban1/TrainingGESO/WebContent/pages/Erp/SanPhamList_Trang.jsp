...
<body>
<form name="erpDmhForm" method="post" action="../../SanPhamList_TrangSvl">
                		 ...
                		 <LEGEND class="legendtitle">Tìm kiếm &nbsp;</LEGEND>
							<TABLE  width="100%" cellpadding="6" cellspacing="0">
								<tr>
								    ...
								    <TD class="plainlabel">
								    	<input type = "text" name = "maSanPham" onchange = "submitform()" value = "<%=obj.getMaSanPham()%>"placeholder = "Ex: 100000">
								    </TD>
								</tr>
								...
								<tr>
								    ...
								    <TD class="plainlabel">
								    	<input type = "text" name = "tenSanPham" onchange = "submitform()" value = "<%=obj.getTenSanPham()%>"placeholder = "Ex: 100000">
								    </TD>
								</tr>
								...
								<!-- lay du lieu tu method getDataDonVi() -->
								    ...
								    <TD class="plainlabel">
								    	<select name="donViTinh" onchange="submitform()" style="width: 200px">
					...
					<%
                   	...
                   	%>
		                    ...
		                    %>
				                    ...
				                    <TD align="center">
				                    	<A href = "../../SanPham_TrangSvl?userId=<%=userId%>&display=<%= dataList.getString("MASANPHAM") %>">
				                    		<IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0>
				                    	</A>&nbsp;
				                   	
											<% if (maTrangThai.equals("1")) {%>
												
												<A href = "../../SanPham_TrangSvl?userId=<%=userId%>&update=<%= dataList.getString("MASANPHAM") %>">
				                               		<IMG src="../images/edit32.png" width="20" height="20" alt="Cap nhat" title="Cập nhật" border=0>
												</A>								
												<A href = "../../SanPhamList_TrangSvl?userId=<%=userId%>&delete=<%= dataList.getString("MASANPHAM")%>">
