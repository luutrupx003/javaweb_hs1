...
<html>
	...
	<body leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
		<form name="dmhForm" method="post" action="../../SanPhamNewSvl_kiet06">
			...
			<input type = "hidden" name= "id" value= '<%=sp.getPk_seq() %>'>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<TD width="30px" align="left"><span id="btnUndo">
							 <A href="../../SanPhamListSvl_kiet06?userId=<%=userId%>"> <IMG
				...
				<fieldset>
					...
					<table width= 100% cellpadding="4" cellspacing="0">
						...
						<tr>
							...
							<td class= "plainlabel">
								<input type= "text" name= "maSanPham" value="<%= sp.getMa()%>" placeholder= "Ex: VT100">
							</td>
						</tr>
						...
						<tr >
							...
							<td class= "plainlabel">
								<input type= "text" name= "tenSanPham" value="<%= sp.getTen() %>" placeholder= "Ex: VIETTEL100">
							</td>
						</tr>
						...
						<tr>
							...
							<td class= "plainlabel">
								<select name= "maDonVi" style= "width: 200px">
									<option value = ""></option>
									<%	if (rsDonVi != null){
										while (rsDonVi.next()){
											if (rsDonVi.getString("pk_seq").equals(sp.getDonViTinh())){
												%>
												<option selected="selected" value="<%= rsDonVi.getString("pk_seq")%>">
