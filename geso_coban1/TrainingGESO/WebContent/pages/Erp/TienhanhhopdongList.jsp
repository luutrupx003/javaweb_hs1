...
<%@page import="geso.erp.beans.Tienhanhhopdongdaky_hieu.imp.TienhanhhopdongdakyList"%>
<%@page import="geso.erp.beans.Tienhanhhopdongdaky_hieu.ITienhanhhopdongdakyList"%>
...
<body>
	<form name="erpDmhForm" method="post" action="../../TienhanhhopdongdakyListSvl_hieu">
						...
						<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><A
 								...
 								if (tt.equals("1")) {
 									%>  
 									<A href="../../TienhanhhopdongdakyUpdateSvl_hieu?userId=<%=userId%>&update=<%=dataList.getString("ma")%>">
